...
import com.themon.test.mlkit_faciallandmarks.common.VisionImageProcessor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    public FrameMetadata getLatestImageMetadata() {
        return this.processingMetaData;
    }

    protected List<FirebaseVisionFace> faces;
